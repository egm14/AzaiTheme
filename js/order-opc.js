  ...
  if ((typeof isLogged == 'undefined' || !isLogged) || (typeof isGuest !== 'undefined' && isGuest)) {
    if (guestCheckoutEnabled && !isLogged && !isGuest) {
     ...
     $(document).on('click', '#opc_createAccount', function(e) {
        ...
        $('#login_form_content').hide(600);
        $('#is_new_customer').val('1');
        $('#opc_invoice_address').hide();
        $('#opc_guestCheckout').removeClass('order-color-box');
        $('#opc_createAccount').addClass('order-color-box');
        $('form#login_form').removeClass('order-color-box');
        $('#opc_new_account div#opc_account_form').removeClass('account_form_active').addClass('account_form_active2').slideDown('slow');
        $('#opc_account_choice .bullet, #opc_invoice_address').hide(600);
        $('#new_account_title_form').html(txtCreateNewAccount);
        /*$('#opc-account_choice').css('flex-direction', 'column-reverse');*/
      ...
      $(document).on('click', '#opc_guestCheckout', function(e) {
        ...
        $('#opc_invoice_address').hide();
        $('#opc_guestCheckout').addClass('order-color-box');
        $('#opc_createAccount').removeClass('order-color-box');
        $('form#login_form').removeClass('order-color-box');
        $('#opc_new_account div#opc_account_form').removeClass('account_form_active2').addClass('account_form_active').slideDown('slow');
    ...
    $(document).on('click', '#openLoginFormBlock', function(e) {
      e.preventDefault();
      $('#openNewAccountBlock').show('slow');
      $('#opc_account_form').hide(600);
      $('#opc_guestCheckout').removeClass('order-color-box');
      $('#opc_createAccount').removeClass('order-color-box');
      $('form#login_form').addClass('order-color-box');
      /*$(this).hide();*/
