    ...
    <div class="primary_block row">    
       ...
       <h1 itemprop="name">{$product->name|escape:'html':'UTF-8'}</h1>
        <div class="product-info-line">
          ...
          <p id="product_reference" >
            <!-- {if empty($product->reference) || !$product->reference}"{/if} style="display:none;" -->
           <label>{l s='Reference:'} </label>
           <span class="editable" itemprop="sku"{if !empty($product->reference) && $product->reference} content="{$product->reference}"{/if}>{if !isset($groups)}{$product->reference|escape:'html':'UTF-8'}{/if}</span>
          </p>
          <p id="supplier_reference"><!--  {if !$product->supplier_reference}style="display: none;"{/if} -->
            <label for="manufacturer_name">{l s='S.Reference :'} </label><span class="editable">{$product->supplier_reference|escape:'html':'UTF-8'}</span></p>
              ...
              <div class="product_attributes clearfix">
                ...
                <div id="attributes">
                  ...
                  {if ($product->category == 'rings') or ($product->category == 'jewelry-rings')}
                      <span><a target="_blank" class="" href="{$content_dir}themes/azai-theme/assets/Azai-RingSizeguide.pdf">{l s='Sizes chart Ring'}</a></span>
                      <script type="text/javascript">
                        console.log('Size Chart Rings');
                      </script>
                    {elseif ($product->category == 'jewelry')}
                      <span><a target="_blank" class="sizes-chart" href="{$content_dir}themes/azai-theme/assets/Azai-RingSizeguide.pdf">{l s='Sizes chart Jewelry'}</a></span>
                        <script type="text/javascript">
                    ...
                    {else}
                        <span ><a class="sizes-chart" href="{$base_dir}content/8-azai-size-chart?content_only=1">{l s='Sizes chart'}</a></span>
                        <script type="text/javascript">
 	...
 	<div>
        {if isset($product) && $product->description}
                <h3 class="page-product-heading descripcion">{l s='Details'}</h3>
                <div id="product-description-tab-content" class="product-description-tab-content tab-pane proof">
