<div class="paiement_block">
  ...
  {if $HOOK_PAYMENT}
    ...
    <p class="payment_module">
      {if $lang_iso == 'en'}
      <a class="cards" href="#" title="Pay with Credit Card">Credit Card</a>
      {elseif $lang_iso == 'es'}
      <a class="cards" href="#" title="Pago con tarjeta">Tarjeta de Crédito</a>
      {/if}
    </p>
      </div>
      <div class="col-xs-12 col-md-8">
    <p class="payment_module">
      <a class="paypal" href="#" title="Paypal">Paypal</a>
    </p>
      </div>
      <div class="col-xs-12 col-md-8">
    <p class="payment_module">
      <a class="applepay" href="#" title="ApplePay">Apple Pay</a>
    </p>
      </div>
      <div class="col-xs-12 col-md-8">
    <p class="payment_module">
      <a class="androidpay" href="#" title="AndroidPay">Android Pay</a>
    </p>
      </div> -->
    </div>
    {if $opc}
