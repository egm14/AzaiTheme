<div id="opc_new_account" class="opc-main-block">
  ...
  <!--LOGIN -->
  <!--<a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" id="openLoginFormBlock">-->
  <form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
    <fieldset  id="openLoginFormBlock">
      <h3 class="page-subheading"><i class="fa fa-user"></i>{l s='Already registered?'}</h3>
      <p>{l s='Start session now'}</p>
      <div id="login_form_content" style="display:none;">
        ...
        <p class="form-group">
          ...
          <input placeholder="email@example.com" type="email" class="form-control validate" id="login_email" name="email" data-validate="isEmail" />
        </p>
        <p class="form-group">
          <label for="login_passwd">{l s='Password'}</label>
          <input placeholder="Enter your password" class="form-control validate" type="password" id="login_passwd" name="login_passwd" data-validate="isPasswd" />
        </p>
    ...
    <fieldset>
      <div class=""><!--CLASS="box" -->
        ...
        <div id="opc_account_choice" class="row">
          <!-- NEW CUSTOMER -->
          <div id="opc_createAccount" class="col-xs-12 col-md-6 box"><!--e_new_customer -->
          <h3 id="new_account_title" class="page-subheading">
          <i class="fa fa-user-plus"></i>{l s='New Customer'}</h3>
          ...
          <div id="opc_guestCheckout" class="col-xs-12 col-md-6 box"><!--e_instant_checkout -->
            <h3 id="new_account_title" class="page-subheading">
              <i class="fa fa-check"></i></i>{l s='Guest Checkout'}</h3>
            <p>{l s='You can checkout without creating an account.'}</p>
            <!--<p class="opc-button">
        ...
        <div id="opc_account_form" class="unvisible">
          ...
          <div class="required text form-group">
            ...
            <input placeholder="email@example.com" type="email" class="text form-control validate" id="email" name="email" data-validate="isEmail" value="{if isset($guestInformations) && isset($guestInformations.email) && $guestInformations.email}{$guestInformations.email}{/if}" />
          </div>
          <div class="required password is_customer_param form-group">
            <label for="passwd">{l s='Password'} <sup>*</sup></label>
            <input placeholder="Enter your password" type="password" class="text form-control validate" name="passwd" id="passwd" data-validate="isPasswd" />
          ...
          {foreach from=$dlv_all_fields item=field_name}
            ...
            {elseif $field_name eq "firstname"}
              <div class="required text form-group">
                <label for="firstname">{l s='First name'} <sup>*</sup></label>
                <input placeholder="Enter your name" type="text" class="text form-control validate" id="firstname" name="firstname" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.firstname) && $guestInformations.firstname}{$guestInformations.firstname}{/if}" />
              </div>
            {elseif $field_name eq "lastname"}
              <div class="required text form-group">
                <label for="lastname">{l s='Last name'} <sup>*</sup></label>
                <input placeholder="Enter your last name" type="text" class="text form-control validate" id="lastname" name="lastname" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.lastname) && $guestInformations.lastname}{$guestInformations.lastname}{/if}" />
              </div>
            {elseif $field_name eq "address1"}
              <div class="required text form-group">
                <label for="address1">{l s='Address'} <sup>*</sup></label>
                <input placeholder="Enter your address" type="text" class="text form-control validate" name="address1" id="address1" data-validate="isAddress" value="{if isset($guestInformations) && isset($guestInformations.address1) && isset($guestInformations) && isset($guestInformations.address1) && $guestInformations.address1}{$guestInformations.address1}{/if}" />
              </div>
            {elseif $field_name eq "address2"}
              <div class="text{if !in_array($field_name, $required_fields)} is_customer_param{/if} form-group">
                ...
                <input placeholder="Enter your address" type="text" class="text form-control validate" name="address2" id="address2" data-validate="isAddress" value="{if isset($guestInformations) && isset($guestInformations.address2) && isset($guestInformations) && isset($guestInformations.address2) && $guestInformations.address2}{$guestInformations.address2}{/if}" />
              </div>
            {elseif $field_name eq "postcode"}
              {$postCodeExist = true}
              <div class="required postcode text form-group">
                <label for="postcode">{l s='Zip/Postal code'} <sup>*</sup></label>
                <input placeholder="Enter your zip code" type="text" class="text form-control validate" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($guestInformations) && isset($guestInformations.postcode) && $guestInformations.postcode}{$guestInformations.postcode}{/if}"/>
              </div>
            {elseif $field_name eq "city"}
              <div class="required text form-group">
                <label for="city">{l s='City'} <sup>*</sup></label>
                <input placeholder="Enter your city" type="text" class="text form-control validate" name="city" id="city" data-validate="isCityName" value="{if isset($guestInformations) && isset($guestInformations.city) && $guestInformations.city}{$guestInformations.city}{/if}" />
              </div>
          ...
          <div class="form-group is_customer_param">
            ...
            <input placeholder="Enter your number phone" type="text" class="text form-control validate" name="phone" id="phone" data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone) && $guestInformations.phone}{$guestInformations.phone}{/if}" />
          </div>
          <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
            <label for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
            <input placeholder="Enter your number phone" type="text" class="text form-control validate" name="phone_mobile" id="phone_mobile" data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone_mobile) && $guestInformations.phone_mobile}{$guestInformations.phone_mobile}{/if}" />
          </div>
          ...
          <div class="checkbox">
            ...
            <label for="invoice_address">
              {l s='Check here to use another address for invoice.'}
            </label>
          </div>
            ...
            {foreach from=$inv_all_fields item=field_name}
              ...
              {elseif $field_name eq "firstname"}
                <div class="required form-group">
                  ...
                  <input placeholder="Enter your name" type="text" class="form-control validate" id="firstname_invoice" name="firstname_invoice" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.firstname_invoice) && $guestInformations.firstname_invoice}{$guestInformations.firstname_invoice}{/if}" />
                </div>
              {elseif $field_name eq "lastname"}
                <div class="required form-group">
