...
<div class="addresses clearfix">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-6">
      <ul class="address alternate_item{if $cart->isVirtualCart()} full_width{/if} box" id="address_invoice"{if $cart->id_address_invoice == $cart->id_address_delivery} style="display: none;"{/if}>
      </ul>
    </div>
  </div> <!-- end row -->
