{if isset($order)}
  ...
  {else}
    <p class="alert alert-info">To return the merchandise <strong><span style="text-decoration: underline;"><a href="/returns" target="_blank" rel="noopener"><span style="color: #000080; text-decoration: underline;">click here</span></a></span></strong> or convert your guest account into a user account <span style="color: #000080;"><strong><a style="color: #000080;" href="#guestToCustomer">click here.</a></strong></span></p>
  {/if}
{/if}