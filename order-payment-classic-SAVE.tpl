        ...
        <table id="cart_summary" class="table table-bordered">
          ...
          <tfoot>
            {if $use_taxes}
              {if $priceDisplay}
                <tr class="cart_total_price">
                  <td colspan="3">&nbsp;</td>
                  <td class="text-right">{if $display_tax_label}{l s='Total products (tax excl.)'}{else}{l s='Total products'}{/if}</td>
                  <td colspan="2" class="price" id="total_product">{displayPrice price=$total_products}</td>
                </tr>
              {else}
                <tr class="cart_total_price">
                  <td colspan="3">&nbsp;</td>
                  <td class="text-right">{if $display_tax_label}{l s='Total products (tax incl.)'}{else}{l s='Total products'}{/if}</td>
            ...
            {else}
              <tr class="cart_total_price">
                <td colspan="3">&nbsp;</td>
                  <td class="text-right">{l s='Total products'}</td>
                <td colspan="2" class="price" id="total_product">{displayPrice price=$total_products}</td>
              </tr>
            {/if}
            ...
            {if $use_taxes}
              {if $total_tax != 0 && $show_taxes}
                {if $priceDisplay != 0}
                  <tr class="cart_total_price">
                    <td colspan="3">&nbsp;</td>
                  <td class="text-right">{if $display_tax_label}{l s='Total (tax excl.)'}{else}{l s='Total'}{/if}</td>
              ...
              <tr class="cart_total_price">
                <td colspan="3">&nbsp;</td>
                  <td class="total_price_container text-right"><span>{l s='Total'}</span></td>
            ...
            {else}
              <tr class="cart_total_price">
                ...
                {if !$voucherAllowed}
                	<td colspan="3">&nbsp;</td>
                	<td class="text-right total_price_container">
                {else}
