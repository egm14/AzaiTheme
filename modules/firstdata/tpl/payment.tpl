...
<p class="payment_module">
	...
	<h5 class="stripe_title"><img alt="" src="{$module_dir}img/secure-icon.png" />{l s='Secure payment by credit card with FirstData' mod='firstdata'}</h5>
	<form action="{$module_dir}validation.php" method="post" name="firstdata_form" id="firstdata_form">
		<div id="firstdataFrame">
			...
			<div class="clear"></div>
			<input type="submit" id="firstdata_submit" value="{l s='Validate order' mod='firstdata'}" class="btn-sm btn btn-secondary" />
