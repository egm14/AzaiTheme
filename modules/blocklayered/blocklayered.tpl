        ...
        <div>
          ...
          {foreach from=$filters item=filter}
            {if isset($filter.values)}
              ...
              {/if}
              <div class="layered_subtitle_heading titulo_{$filter.name}">
                  ...
                  {if $filter.filter_type == 0}
                    {foreach from=$filter.values key=id_value item=value name=fe}
                      {if $value.nbr || !$hide_0_values}
                        <li class="nomargin {if $smarty.foreach.fe.index >= $filter.filter_show_limit}hiddable{/if} col-xs-6 col-sm-6 col-md-6 col-lg-6">
