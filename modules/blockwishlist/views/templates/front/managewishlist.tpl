...
{if $products}
  {if !$refresh}
    ...
    <!--<p class="wishlisturl form-group">
      ...
      <a class="btn btn-default btn-sm smlist" href="{$link->getModuleLink('blockwishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}"><!--<input type="text" class="form-control" value="{$link->getModuleLink('blockwishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}" readonly="readonly"/> {l s='See My List' mod='blockwishlist'} </a>
    </p> -->
    <p class="submit">
      <div id="showSendWishlist">
      <a class="btn btn-default btn-sm smlist" href="{$link->getModuleLink('blockwishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}"><!--<input type="text" class="form-control" value="{$link->getModuleLink('blockwishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}" readonly="readonly"/> -->{l s='See My List' mod='blockwishlist'} </a>
        <a class="btn btn-default btn-sm smlist" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
  ...
  {if !$refresh}
    <form method="post" class="wl_send box unvisible" onsubmit="return (false);">
      ...
      <fieldset>
        ...
        <button style="display:none;" id="mostrar" class="btn btn-default btn-sm" onclick="mostrar();" >
            <span>mostrar</span>
          </button>
