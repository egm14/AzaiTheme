                            ...
                            <tr id="wishlist_{$wishlists[i].id_wishlist|intval}">
                               ...
                               {if !$single_mode}
                                ...
                                <td class="col-xs-2 col-md-2 wishlist_delete">
                                    <a class="icon" href="#" style="background:none;" onclick="javascript:event.preventDefault();return (WishlistDelete('wishlist_{$wishlists[i].id_wishlist|intval}', '{$wishlists[i].id_wishlist|intval}', '{l s='Do you really want to delete this wishlist ?' mod='advansedwishlist' js=1}'));">
                                                {if $wl_custom_font}
                                                <span class="jms-arrows-remove-1" style="background-color:red; color:white;padding:5px 6px;text-shadow:0 0px 0 #fff;border-radius:5px;">X</span>
                                                {else}
                                                {if $advansedwishlistis17 == 1}
