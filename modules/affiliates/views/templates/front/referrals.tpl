...

{
	...
	//Add referlink to list and fix the string
	 var cuento = ref_link.split("=");

	 $('#referlink').html(cuento[2]);
...
<div id="referrals">
	...
	<div class="text form-group">
		<ul class="well" style="list-style:inside none disc;">
			...
			<!---------- Add REFER_AFF_LINK --------- -->
			<li  style="font-size:1.2em;font-weight:700;padding:20px 30px; background-color:#7cffbc;color:black;border:2px solid #238409;border-style:dashed; outline-offset:5px; display:inline-block;text-align:center;margin-bottom:10px">
				<h3 id="referlink">Codigo referencia</h3>
				<p style="color:gray;font-size:16px;">{l s='Discount 10%'}</p>
			</li>
			<!---------- END REFER_AFF_LINK --------- -->

			<li>{l s='Share this URL to invite your referrals.' mod='affiliates'}</li>
			<li>{l s='URL' mod='affiliates'} : <u style="word-wrap: break-word;">{$ref_link|escape:'htmlall':'UTF-8'}</u></li>
		</ul>
		<br/>
